...
/**
 * Testing: Mock Polar workout data for development
 */
export const mockPolarWorkout: WorkoutData = {
  id: 'test-workout-001',
  'upload-time': '2025-11-11T10:00:00.000Z',
  'polar-user': 'test-user',
  device: 'Polar H10',
  'device-id': 'test-device',
  'start-time': '2025-11-11T08:00:00.000Z',
  ...
  'running-index': 52,
  'training-load-pro': {
    carbohydrate_consumption: 105,
    fat_consumption: 228,
    protein_consumption: 18,
    muscle_load: 45,
    perceived_load: 40,
    cardio_load: 42
  }
 ...
 */
export async function testWithMockData(userId: string): Promise<void> {
  console.log('Testing with mock Polar workout...');
  
  const result = await processPolarWorkout(userId, mockPolarWorkout);
