...
interface DailyStepsAreaChartProps {
  chartData: { name: string; steps: number }[];
  date?: Date;
}

export const DailyStepsAreaChart = ({ chartData, date }: DailyStepsAreaChartProps) => {
          ...
          <Svg height={chartHeight} width={plotWidth} style={{ overflow: 'visible' }}>
            <Defs>
              <LinearGradient id="grad" x1="0" y1="0" x2="0" y2="1">
                ...
                <Stop offset="1" stopColor="#4ECDC4" stopOpacity="0.1" />
              </LinearGradient>
            </Defs>
